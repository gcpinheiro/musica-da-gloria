...
export const SCHEDULES_MOCK: readonly Schedule[] = [
  ...
  { id: 'occ-004', title: 'Santa Missa Dominical', date: isoDate(6), time: '19:00', location: 'Igreja Matriz', ministry: 'Magnificat', status: 'PUBLISHED', liturgicalTime: '25º Domingo do Tempo Comum', notes: 'Chegada às 18h para ensaio breve.', people: [SCHEDULE_MEMBER_OPTIONS[0], SCHEDULE_MEMBER_OPTIONS[1]], songs: songs(['song-001', 'song-003', 'song-004']) },
];
